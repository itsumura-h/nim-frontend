...
# Dependencies
requires "nim >= 1.6.6"
requires "https://github.com/itsumura-h/nim-basolato >= 0.12.1"
...
task js, "compire js":
  echo staticExec("nim js -d:release -o:public/js/hello_nim.js app/http/views/components/hello_nim.nim")
